...
int main() {
    ...
    MPC mpc;
    double last_v =0;
    h.onMessage([&mpc,&last_v](uWS::WebSocket<uWS::SERVER> ws, char *data, size_t length,
                       uWS::OpCode opCode) {
            ...
            if (s != "") {
                ...
                if (event == "telemetry") {
                    ...
                    */
                    ...
                    auto vars = mpc.Solve(state, coefs);
                    ...
                    for (int i = 1; i < num_points; i++) {
                        ...
                        next_y_vals.push_back(polyeval(coefs, poly_inc * i));
                    }
